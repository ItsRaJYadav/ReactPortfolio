                ...
                <div className="flex">
                  <Link
                    ...
                    className={`text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium ${
                      activeLink === 'experience' ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700'
                    }`}
                  >
                    Experience
                  </Link>
                  <Link
                    ...
                    className={`text-gray-300 hover:text-white ml-4 px-3 py-2 rounded-md text-sm font-medium ${
                      activeLink === 'education' ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700'
                    }`}
                  >
                    Education
                  </Link>
